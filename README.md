...
Bem-vindo ao repositório do projeto java_api_condominio. Esta é a API back-end que suporta o sistema de gerenciamento de condomínios, desenvolvida com JAVA versão 21 com Spring Boot.
...
Para testar no Swagger ou no frontend em Angular use:
